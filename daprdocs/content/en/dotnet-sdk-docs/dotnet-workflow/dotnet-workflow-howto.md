...
```bash
curl -i -X POST http://localhost:3500/workflows/dapr/OrderProcessingWorkflow/start?instanceID=12345678 \
...
```bash
curl -i -X GET http://localhost:3500/workflows/dapr/12345678
```
