...
```bash
dapr run --components-path ./Components --app-id generator --app-port 5000 -- dotnet run
```
...
dapr run --components-path ./Components --app-id worker --app-port 5002 -- dotnet run
```
