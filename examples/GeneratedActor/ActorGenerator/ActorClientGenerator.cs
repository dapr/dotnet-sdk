...
public sealed class ActorClientGenerator : ISourceGenerator
{
    private sealed class ActorInterfaceSyntaxReceiver : ISyntaxContextReceiver
    {
        ...
        public void OnVisitSyntaxNode(GeneratorSyntaxContext context)
        {
            ...
            {
                context.SemanticModel.GetDeclaredSymbol(interfaceDeclarationSyntax);
    ...
    public void Execute(GeneratorExecutionContext context)
    {
        ...
        foreach (var model in actorInterfaceSyntaxReceiver.Models)
        {
            ...
            var actorInterfaceTypeName = symbol!.ToString();
...
namespace {"bar"}
{{
    public sealed class {actorInterfaceTypeName}ManualProxy : {actorInterfaceTypeName}
    {{
...
";
            ...
            context.AddSource($"bar.g.cs", source);
        }
    }
