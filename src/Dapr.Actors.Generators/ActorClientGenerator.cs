...
{{
        ...
        CancellationToken cancellationToken)
    {
        ...
        return new ActorClientDescriptor
        {
            ...
            ClientTypeName = GetClientName(actorInterfaceSymbol, attributeData),
            Methods = members,
    ...
    static void GenerateActorClientCode(SourceProductionContext context, ActorClientDescriptor? descriptor)
    {
        ...
        try
        {
            ...
            var methodImplementations = string.Join(
                "\n",
                descriptor.Methods.Select(member => GenerateMethodImplementation(member, actorMethodAttributeSymbol, cancellationTokenSymbol)));
...
{{
        ...
        INamedTypeSymbol cancellationTokenSymbol)
    {
        ...
        if (cancellationTokenParameter is not null && cancellationTokenIndex != method.Parameters.Length - 1)
        {
            ...
            {
                // TODO: improve description of exception with method name and parameter name
                CancellationTokensMustBeTheLastArgument.CreateDiagnostic(cancellationTokenParameter, "")
            });
        }
