...
namespace Dapr.Actors
{
    ...
    internal interface IDaprInteractor
    {
        ...
        /// <param name="grpcData">GRPC data with state changes as per the Dapr spec for transaction state update.</param>
        /// <param name="cancellationToken">Cancels the operation.</param>
        /// <returns>A task that represents the asynchronous operation.</returns>
        Task SaveStateTransactionallyAsync(string actorType, string actorId, string data, CancellationToken cancellationToken = default, List<Autogenerated.TransactionalActorStateOperation> grpcData = default);
        ...
        /// <param name="actorType">Type of actor.</param>
        /// <param name="actorId">ActorId.</param>
        /// <param name="stateChanges">StateChanges.</param>
        /// <param name="actorStateSerializer">StateChanges.</param>
        /// <param name="jsonSerializerOptions">StateChanges.</param>
        /// <param name="cancellationToken">Cancels the operation.</param>
        /// <returns>A <see cref="Task"/> representing the result of the asynchronous operation.</returns>
        Task DoStateChangesTransactionallyAsync(string actorType, string actorId, IReadOnlyCollection<ActorStateChange> stateChanges, IActorStateSerializer actorStateSerializer, JsonSerializerOptions jsonSerializerOptions, CancellationToken cancellationToken = default);
