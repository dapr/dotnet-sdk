...
namespace Dapr.Actors.Runtime
{
    ...
    public abstract class Actor
    {
        ...
        protected Task<IActorTimer> RegisterTimerAsync(
            ...
            TimeSpan period)
        {
            return this.RegisterTimerAsync(null, timerCallback, Encoding.UTF8.GetBytes(state.ToString()), dueTime, period);
        }
            ...
            TimeSpan period)
        {
            ...
            var timerInfo = new TimerInfo(timerCallback, state, dueTime, period);
