...
namespace Dapr.Actors.Runtime
{
    ...
    internal class DaprStateProvider
    {
        ...
        {
            await this.daprInteractor.DoStateChangesTransactionallyAsync(this, actorType, actorId, stateChanges, cancellationToken);
        }
        ...
        public async Task DoStateChangesTransactionallyAsyncGrpc(string actorType, string actorId, IReadOnlyCollection<ActorStateChange> stateChanges, CancellationToken cancellationToken = default)
        {
            ...
            await this.daprInteractor.SaveStateTransactionallyAsync(actorType, actorId, null, cancellationToken, grpcOps);
        }

        public async Task DoStateChangesTransactionallyAsyncHttp(string actorType, string actorId, IReadOnlyCollection<ActorStateChange> stateChanges, CancellationToken cancellationToken = default)
        {
            ...
            */
            ...
            await this.daprInteractor.SaveStateTransactionallyAsync(actorType, actorId, content, cancellationToken, null);
        }
