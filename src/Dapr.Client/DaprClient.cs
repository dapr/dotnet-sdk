...
namespace Dapr.Client
{
    ...
    public abstract class DaprClient : IDisposable
    {
        ...
        public Task InvokeMethodAsync<TRequest>(
            ...
            CancellationToken cancellationToken = default)
        {
            var request = CreateInvokeMethodRequest(httpMethod, appId, methodName, data);
            return InvokeMethodAsync(request, cancellationToken);
        }
        ...
        public abstract Task<(TValue?, string Etag)> GetStateAndETagAsync<TValue>(string storeName, string key, ConsistencyMode? consistencyMode = default, IReadOnlyDictionary<string, string>? metadata = default, CancellationToken cancellationToken = default);
