...
namespace Dapr.Client
{
    ...
    public class DaprClient : IDaprClient
    {
        ...
        public override Task PublishEventAsync<TRequest>(string topicName, TRequest publishContent, CancellationToken cancellationToken = default)
        {
            ...
            return MakePublishHttpRequest(topicName, publishContent, cancellationToken);
        }
        ...
        public override Task PublishEventAsync(string topicName, CancellationToken cancellationToken = default)
        {
            ...
            return MakePublishHttpRequest(topicName, string.Empty, cancellationToken);
        }

        private async Task MakePublishHttpRequest<TRequest>(string topicName, TRequest publishContent, CancellationToken cancellationToken)
        {
