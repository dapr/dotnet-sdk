    ...
    public sealed class DaprClientBuilder
    {
        ...
        public DaprClient Build()
        {
            ...
            if (this.Timeout > 0)
            {
                ...
                var timeout = TimeSpan.FromMilliseconds(this.Timeout);
                callInvoker = new TimeoutCallInvoker(callInvoker, timeout);
            }
            var client = new Autogenerated.Dapr.DaprClient(callInvoker);
