...
namespace Dapr.Client
{
    ...
    internal class DaprClientGrpc : DaprClient
    {
        ...
        /// <inheritdoc />
        [Obsolete("The API is currently not stable as it is in the Alpha stage. This attribute will be removed once it is stable.")]
        public override async Task<ReadOnlyMemory<byte>> EncryptAsync(string vaultResourceName, Stream plaintextStream,
            string keyName, EncryptionOptions encryptionOptions, CancellationToken cancellationToken = default)
        {
            ...
            //Stream the data to the sidecar asynchronously
            var sendStreamedData = SendEncryptedStreamAsync(plaintextStream,
                (int)encryptionOptions.StreamingBlockSizeInBytes, duplexStream, encryptRequestOptions,
                cancellationToken);

            //At the same time, retrieve and buffer the response
            var retrieveStreamedData = RetrieveEncryptedBufferedStreamAsync(duplexStream, cancellationToken);

            //Do both operations at the same time and wait on each to complete
            var result = await Task.WhenAll(sendStreamedData, retrieveStreamedData);
            return result.Last(); //Only care about the buffered response back from the sidecar
        }
        
        private async Task<ReadOnlyMemory<byte>> SendEncryptedStreamAsync(Stream plaintextStream, int streamingBlockSizeInBytes, AsyncDuplexStreamingCall<Autogenerated.EncryptRequest, Autogenerated.EncryptResponse> duplexStream, Autogenerated.EncryptRequestOptions encryptRequestOptions, CancellationToken cancellationToken)
        {
            ...
            await using (var bufferedStream = new BufferedStream(plaintextStream, streamingBlockSizeInBytes))
            {
                ...
                {
                    await duplexStream.RequestStream.WriteAsync(new Autogenerated.EncryptRequest
                    {
        ...
        private async Task<ReadOnlyMemory<byte>> RetrieveEncryptedBufferedStreamAsync(AsyncDuplexStreamingCall<Autogenerated.EncryptRequest, Autogenerated.EncryptResponse> duplexStream, CancellationToken cancellationToken)
        {
            //Set up how the response is handled since we know it's of finite length
            ...
            {
                returnedBytes.AddRange(encryptResponse.Payload.Data.ToByteArray());
            }
        ...
        public override async Task<ReadOnlyMemory<byte>> DecryptAsync(string vaultResourceName, Stream ciphertextStream, string keyName, DecryptionOptions decryptionOptions, CancellationToken cancellationToken = default)
        {
            ...
            //Stream the data to the sidecar asynchronously
            var sendStreamedData = SendDecryptedStreamAsync(ciphertextStream,
                (int)decryptionOptions.StreamingBlockSizeInBytes, duplexStream, decryptRequestOptions,
                cancellationToken);

            var retrieveStreamedData = RetrieveDecryptedBufferedStreamAsync(duplexStream, cancellationToken);
        ...
        private async Task<ReadOnlyMemory<byte>> SendDecryptedStreamAsync(Stream ciphertextStream, int streamingBlockSizeInBytes, AsyncDuplexStreamingCall<Autogenerated.DecryptRequest, Autogenerated.DecryptResponse> duplexStream, Autogenerated.DecryptRequestOptions decryptRequestOptions, CancellationToken cancellationToken)
        {
        ...
        private async Task<ReadOnlyMemory<byte>> RetrieveDecryptedBufferedStreamAsync(AsyncDuplexStreamingCall<Autogenerated.DecryptRequest, Autogenerated.DecryptResponse> duplexStream, CancellationToken cancellationToken)
        {
            //Set up how the response is handled since we know it's of finite length
            var returnedBytes = new List<byte>();
            await foreach (var decryptResponse in duplexStream.ResponseStream.ReadAllAsync(cancellationToken).ConfigureAwait(false))
            {
                returnedBytes.AddRange(decryptResponse.Payload.Data.ToByteArray());
            }
