...
namespace Dapr.Client
{
    ...
    internal class DaprClientGrpc : DaprClient
    {
           ...
           CancellationToken cancellationToken = default)
        {
            ...
            ArgumentVerifier.ThrowIfNullOrEmpty(key, nameof(key));
            ArgumentVerifier.ThrowIfNull(etag, nameof(etag));
            return await this.MakeSaveStateCallByteAsync(storeName, key, value, etag, stateOptions, metadata, cancellationToken);
        }
             ...
             CancellationToken cancellationToken = default)
        {
            ...
            if (value != null)
            {
                //convert byte array to byte string value
                stateItem.Value = ByteString.CopyFrom(value);
            }
