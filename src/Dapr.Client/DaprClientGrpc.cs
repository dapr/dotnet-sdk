...
namespace Dapr.Client
{
    ...
    internal class DaprClientGrpc : DaprClient
    {
        ...
        private async Task<byte[]> EncryptAsync(string vaultResourceName, byte[] plainTextBytes,
        ...
        public override Task<byte[]> EncryptAsync(
            ...
            CancellationToken cancellationToken = default) => EncryptAsync(vaultResourceName, plainTextBytes,
