...
namespace Dapr.Client
{
    ...
    internal class DaprClientGrpc : DaprClient
    {
            ...
            CancellationToken cancellationToken = default)
        {
            ArgumentVerifier.ThrowIfNullOrEmpty(storeName, nameof(storeName));
            ArgumentVerifier.ThrowIfNullOrEmpty(key, nameof(key));
            ArgumentVerifier.ThrowIfEmpty(etag, nameof(etag));
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            if (etag != null)
            {
                stateItem.Etag = new Autogenerated.Etag()
                {
                    Value = etag
                };
            }
        ...
        private Autogenerated.StateItem ToAutogeneratedStateItem(StateTransactionRequest state)
        {
            ...
            if (state.ETag != null)
            {
                stateOperation.Etag = new Autogenerated.Etag
                {
                    Value = state.ETag
                };
            }
           ...
           CancellationToken cancellationToken = default)
        {
            ...
            if (etag != null)
            {
                deleteStateEnvelope.Etag = new Autogenerated.Etag
                {
                    Value = etag
                };
            }
