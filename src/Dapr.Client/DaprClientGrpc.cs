...
namespace Dapr.Client
{
    ...
    internal class DaprClientGrpc : DaprClient
    {
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            var options = CreateCallOptions(headers: null, cancellationToken);
            Autogenerated.TryLockResponse response = new Autogenerated.TryLockResponse();
            try
            {
                response = await client.TryLockAlpha1Async(request, options);
            }
            catch (RpcException ex)
            {
        ...
        private static LockStatus GetUnLockStatus(Autogenerated.UnlockResponse.Types.Status status)
        {
            return status switch
            {
                ...
                Autogenerated.UnlockResponse.Types.Status.LockUnexist => LockStatus.LockUnexist,
                Autogenerated.UnlockResponse.Types.Status.LockBelongToOthers => LockStatus.LockBelongToOthers,
