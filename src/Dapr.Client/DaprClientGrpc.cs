...
namespace Dapr.Client
{
    ...
    internal class DaprClientGrpc : DaprClient
    {
        ...
        public static ServiceInvocationException<TRequest, TResponse> ProcessRpcException<TRequest, TResponse>(RpcException ex, ServiceInvocationResponse<TRequest, TResponse> invokeResponse)
        {
