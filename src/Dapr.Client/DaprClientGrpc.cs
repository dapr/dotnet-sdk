...
namespace Dapr.Client
{
    ...
    internal class DaprClientGrpc : DaprClient
    {
        ...
        public override async Task InvokeMethodAsync(
           string appId,
           string methodName,
           HttpInvocationOptions httpExtension = default,
           CancellationToken cancellationToken = default)
        {
        ...
        private (Autogenerated.InvokeServiceRequest, CallOptions) MakeInvokeRequestAsync(
            ...
            string methodName,
            Any data,
            HttpInvocationOptions httpExtension,
            CancellationToken cancellationToken = default)
        {
            ...
            {
                protoHTTPExtension.Verb = ConvertHTTPVerb(httpExtension.Method);
