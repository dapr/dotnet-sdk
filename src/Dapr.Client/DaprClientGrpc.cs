...
namespace Dapr.Client
{
    ...
    internal class DaprClientGrpc : DaprClient
    {
        ...
        /// </summary>
        private async IAsyncEnumerable<byte[]> RetrieveEncryptedStreamAsync(AsyncDuplexStreamingCall<Autogenerated.EncryptRequest, Autogenerated.EncryptResponse> duplexStream, [EnumeratorCancellation] CancellationToken cancellationToken)
        {
            await foreach (var encryptResponse in duplexStream.ResponseStream.ReadAllAsync(cancellationToken)
                               .ConfigureAwait(false))
            {
                yield return encryptResponse.Payload.Data.ToByteArray();
            }
        }
        ...
        /// </summary>
        private async IAsyncEnumerable<byte[]> SendCiphertextStreamAsync(Stream ciphertextStream,
            int streamingBlockSizeInBytes,
        ...
        /// </summary>
        private async IAsyncEnumerable<byte[]> RetrieveDecryptedStreamAsync(
            AsyncDuplexStreamingCall<Autogenerated.DecryptRequest, Autogenerated.DecryptResponse> duplexStream,
            [EnumeratorCancellation] CancellationToken cancellationToken)
        {
            await foreach (var decryptResponse in duplexStream.ResponseStream.ReadAllAsync(cancellationToken)
                               .ConfigureAwait(false))
            {
                yield return decryptResponse.Payload.Data.ToByteArray();
            }
        }
