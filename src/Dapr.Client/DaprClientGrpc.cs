...
namespace Dapr.Client
{
    ...
    internal class DaprClientGrpc : DaprClient
    {
        ...
        public override async Task<HttpResponseMessage> InvokeMethodWithResponseAsync(HttpRequestMessage? request, CancellationToken cancellationToken = default)
        {
            ...
            if (request.RequestUri is null || !this.httpEndpoint.IsBaseOf(request.RequestUri))
            {
        ...
        public async override Task<TResponse?> InvokeMethodAsync<TResponse>(HttpRequestMessage request, CancellationToken cancellationToken = default) where TResponse : default
        {
            ArgumentVerifier.ThrowIfNull(request, nameof(request));
        ...
        public override async Task SaveBulkStateAsync<TValue>(string storeName, IReadOnlyList<SaveStateItem<TValue>> items, CancellationToken cancellationToken = default)
        {
            ...
            foreach (var item in items)
            {
                ...
                {
                    Key = item.Key, 
                    Etag = new Autogenerated.Etag() { Value = item.ETag }
                };
        ...
        /// <inheritdoc/>
        public override async Task<(TValue?, string Etag)> GetStateAndETagAsync<TValue>(string storeName,
            string key,
            ConsistencyMode? consistencyMode = default,
            IReadOnlyDictionary<string, string>? metadata = default,
            CancellationToken cancellationToken = default) where TValue : default
        ...
        private Autogenerated.StateItem ToAutogeneratedStateItem(StateTransactionRequest state)
        {
            ...
            {
                Key = state.Key, 
                Value = ByteString.CopyFrom(state.Value), 
                Etag = new Autogenerated.Etag() { Value = state.ETag }
            };
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            byte[] jsonUtf8Bytes = Array.Empty<byte>();
