...
namespace Dapr.Client
{
    internal class DaprSubscribeConfigurationSource : ConfigurationSource
    {
        ...
        public override Dictionary<string, ConfigurationItem> GetAsyncEnumerator(CancellationToken cancellationToken = default)
        {
    ...
    internal class DaprSubscribeConfigurationEnumerator : Dictionary<string, ConfigurationItem>
    {
        private AsyncServerStreamingCall<Autogenerated.SubscribeConfigurationResponse> call;
        ...
        public Dictionary<string, ConfigurationItem> Current
        {
            get
            {
                ...
                if (current != null)
                {
                    ...
                    Dictionary<string, ConfigurationItem> configMapResponse = new Dictionary<string, ConfigurationItem>();
                    foreach(KeyValuePair<string, Autogenerated.ConfigurationItem> entry in current.Items) {
                        configMapResponse[entry.Key] = new ConfigurationItem(entry.Value.Value, entry.Value.Version, entry.Value.Metadata);
                    }
