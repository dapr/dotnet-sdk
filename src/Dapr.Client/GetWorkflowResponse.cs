...
namespace Dapr.Client
{
    ...
    public class GetWorkflowResponse
    {
        ...
        public T? ReadInputAs<T>(JsonSerializerOptions? options = null)
        {
            ...
            if (this.Properties is not null && !this.Properties.TryGetValue(defaultInputKey, out serializedInput) || serializedInput is null)
            {
                return default;
            }
        ...
        public T? ReadOutputAs<T>(JsonSerializerOptions? options = null)
        {
            ...
            if (this.Properties is not null && !this.Properties.TryGetValue(defaultOutputKey, out serializedOutput) || serializedOutput is null)
            {
                return default;
            }
