...
internal static class DaprClientBuilderExtensions
{
        ...
        where TClientBuilder : DaprGenericClientBuilder<TClient>
    {
        ...
        // Register the DaprRuntimeCapabilities type for backwards compatibility support
        services.Add(new ServiceDescriptor(typeof(IDaprRuntimeCapabilities), sp =>
        {
            ...
            var (channel, _, _, _) = builder.BuildDaprClientDependencies(Assembly.GetExecutingAssembly());
            return new DaprRuntimeCapabilities(channel);
        }, lifetime));
