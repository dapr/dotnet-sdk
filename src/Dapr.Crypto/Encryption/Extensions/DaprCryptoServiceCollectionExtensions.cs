...
namespace Dapr.Crypto.Encryption.Extensions;

/// <summary>
/// Contains extension methods for using Dapr cryptography with dependency injection.
/// </summary>
public static class DaprCryptoServiceCollectionExtensions
{
    /// <summary>
    ...
    /// <returns></returns>
    public static IDaprCryptoBuilder AddDaprEncryptionClient(
        ...
        ServiceLifetime lifetime = ServiceLifetime.Singleton)
    {
        ...
        return services
            .AddDaprClient<DaprEncryptionClient, DaprEncryptionGrpcClient, DaprCryptoBuilder,
