...
/// </summary>
internal sealed class DaprDecryptionProcessor : DaprEncryptionPipelineProcessorBase<Autogenerated.DecryptRequest, Autogenerated.DecryptRequestOptions, Autogenerated.DecryptResponse>
{
    /// <summary>
