...
internal sealed class DaprEncryptionGrpcClient(Autogenerated.Dapr.DaprClient client, HttpClient httpClient, DaprRuntimeCapabilities runtimeCapabilities, string? daprApiToken = null) : DaprEncryptionClient(client, httpClient, daprApiToken: daprApiToken)
{
        ...
        [EnumeratorCancellation] CancellationToken cancellationToken = default)
    {
        ...
        if (!shouldOmitDecryptionKeyName)
        {
            ...
            encryptRequestOptions.DecryptionKeyName = encryptionOptions.DecryptionKeyName;
        }
