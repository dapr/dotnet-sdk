...
internal sealed class DaprDistributedLockGrpcClient : DaprDistributedLockClient
{
    ...
    /// A client for performing distributed locking operations with Dapr.
    /// </summary>
    public DaprDistributedLockGrpcClient(Autogenerated.Dapr.DaprClient client, HttpClient httpClient, DaprRuntimeCapabilities runtimeCapabilities, string daprApiToken) : base(client, httpClient, daprApiToken)
    {
    }
