...
using Autogenerated = Dapr.Scheduler.Autogen.Grpc.v1;
...
internal class DaprJobsGrpcClient : DaprJobsClient
{
        ...
        DateTime? ttl = null, T? payload = default, CancellationToken cancellationToken = default) where T : default
    {
        ...
        var job = new Autogenerated.Job { Schedule = cronExpression };
        ...
        var jobMetadata = new Autogenerated.JobMetadata
        {
            Namespace = this.options.Namespace,
            AppId = this.options.AppId,
            Target = new Autogenerated.JobTargetMetadata
            {
                Job = new()
            }
        };

        var envelope = new Autogenerated.ScheduleJobRequest { Name = jobName, Job = job, Metadata = jobMetadata };

        var callOptions = CreateCallOptions(headers: null, cancellationToken);

        try
        {
            await client.ScheduleJobAsync(envelope, callOptions);
        }
        ...
        DateTime? ttl = null, T? payload = default, CancellationToken cancellationToken = default) where T : default
    {
        ...
        var job = new Autogenerated.Job { Schedule = interval.ToDurationString() };
        ...
        CancellationToken cancellationToken = default) where T : default
    {
        ...
        var job = new Autogenerated.Job { DueTime = scheduledTime.ToString("O") };
    ...
    public override async Task<JobDetails<T>> GetJobAsync<T>(string jobName, CancellationToken cancellationToken = default)
    {
        ...
        var jobMetadata = new Autogenerated.JobMetadata
        {
            Namespace = this.options.Namespace,
            AppId = this.options.AppId,
            Target = new Autogenerated.JobTargetMetadata { Job = new() }
        };

        var envelope = new Autogenerated.GetJobRequest { Name = jobName, Metadata = jobMetadata };
        ...
        try
        {
            response = await client.GetJobAsync(envelope, callOptions);
        }
        catch (RpcException ex)
        {
            throw new DaprException(
    ...
    public override async Task DeleteJobAsync(string jobName, CancellationToken cancellationToken = default)
    {
        ...
        var envelope = new Autogenerated.DeleteJobRequest { Name = jobName, Metadata = jobMetadata};

        var callOptions = CreateCallOptions(headers: null, cancellationToken);

        try
        {
            await client.DeleteJobAsync(envelope, callOptions);
        }
        catch (RpcException ex)
        {
            throw new DaprException(
    ...
    public override Task<IAsyncEnumerable<WatchedJobDetails<T>>> WatchJobsAsync<T>(
    ...
    /// </summary>
    /// <typeparam name="T">The type to deserialize the job payload to.</typeparam>
    /// <param name="duplexStream">The duplex stream to monitor.</param>
    /// <param name="cancellationToken">Cancellation token.</param>
    /// <returns></returns>
    private async IAsyncEnumerable<WatchedJobDetails<T>> RetrieveWatchedJobsAsync<T>(
        AsyncDuplexStreamingCall<Autogenerated.WatchJobsRequest, Autogenerated.WatchJobsResponse> duplexStream,
        [EnumeratorCancellation] CancellationToken cancellationToken) where T : IMessage, new()
    {
        await foreach (var watchedJob in duplexStream.ResponseStream.ReadAllAsync(cancellationToken)
                           .ConfigureAwait(false))
        {
            yield return new WatchedJobDetails<T>(watchedJob.Id, watchedJob.Name, watchedJob.Data.Unpack<T>());
        }
    }
