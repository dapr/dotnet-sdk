...
/// <summary>
/// Class representing an entry in a bulk publish request.
/// </summary>
/// <typeparam name="TValue">The data type of the value.</typeparam>
/// <param name="entryId">A request scoped ID uniquely identifying this entry in the bulk publish request.</param>
...
public class BulkPublishEntry<TValue>(string entryId, TValue eventData, string contentType, IReadOnlyDictionary<string, string>? metadata = null)
{
    ...
    /// Any particular values in this metadata overrides the request metadata present in the bulk publish request.
    /// </summary>
