...
/// </summary>
/// <param name="failedEntries">The list of <see cref="BulkPublishResponseFailedEntry{TValue}"/> representing the events that failed to be published.</param>
public class BulkPublishResponse<TValue>(List<BulkPublishResponseFailedEntry<TValue>> failedEntries)
{
    /// <summary>
    /// The list of <see cref="BulkPublishResponseFailedEntry{TValue}"/> objects that have failed to publish.
    /// </summary>
