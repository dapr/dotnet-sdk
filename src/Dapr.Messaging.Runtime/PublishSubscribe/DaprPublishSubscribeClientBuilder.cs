...
public sealed class DaprPublishSubscribeClientBuilder(IConfiguration? configuration = null) : DaprGenericClientBuilder<DaprPublishSubscribeClient>(configuration)
{
    ...
    public override DaprPublishSubscribeClient Build()
    {
        ...
        return new DaprPublishSubscribeGrpcClient(client, daprClientDependencies.httpClient, this.JsonSerializerOptions, runtimeCapabilities, daprClientDependencies.daprApiToken);
    }
}
