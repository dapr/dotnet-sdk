...
/// <summary>
/// The base implementation of a Dapr streaming pub/sub client.
/// </summary>
public abstract class DaprPubSubStreamingClient(Autogenerated.Dapr.DaprClient client, HttpClient httpClient, JsonSerializerOptions jsonSerializerOptions, string? daprApiToken = null) : IDaprPubSubStreamingClient
{
    ...
    /// <returns></returns>
    public abstract Task<IAsyncDisposable> SubscribeAsync(string pubSubName, string topicName, DaprStreamingSubscriptionOptions options, TopicMessageHandler messageHandler, CancellationToken cancellationToken = default);
