...
/// </summary>
internal sealed class DaprPubSubStreamingGrpcClient(
    Autogenerated.Dapr.DaprClient client,
    HttpClient httpClient,
    JsonSerializerOptions jsonSerializerOptions,
    string? daprApiToken = null) : DaprPubSubStreamingClient(client, httpClient, jsonSerializerOptions, daprApiToken)
{
    /// <summary>
    ...
    public override async Task<IAsyncDisposable> SubscribeAsync(
        string pubSubName,
        string topicName,
        DaprStreamingSubscriptionOptions options,
