...
{
    /// <summary>
    /// The runtime capabilities of the connected Dapr sidecar. Reserved for future use.
    /// </summary>
    internal IDaprRuntimeCapabilities? RuntimeCapabilities { get; } = runtimeCapabilities;
    /// <inheritdoc />
