...
namespace Microsoft.Actions.Actors.Runtime
{
    ...
    /// <summary>
    /// Represents a reminder registered using <see cref="Microsoft.Actions.Actors.Runtime.Actor.RegisterReminderAsync" />.
    /// </summary>
    public interface IActorReminder
    {
        ...
        /// <remarks>
        /// The first invocation of the reminder occurs after <see cref="Microsoft.Actions.Actors.Runtime.IActorReminder.DueTime" />. All subsequent invocations occur at intervals defined by this property.
        /// </remarks>
        TimeSpan Period { get; }
