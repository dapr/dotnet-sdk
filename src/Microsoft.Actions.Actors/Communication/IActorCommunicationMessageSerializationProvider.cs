...
namespace Microsoft.Actions.Actors.Communication
{
    ...
    /// </summary>
    public interface IActorCommunicationMessageSerializationProvider
    {
        /// <summary>
        /// Create a IServiceRemotingMessageBodyFactory used for creating remoting request and response body.
        /// </summary>
        /// <returns>A custom <see cref="IMessageBodyFactory"/> that can be used for creating remoting request and response message bodies.</returns>
        ...
        /// <returns>
        /// An <see cref="IActorCommunicationRequestMessageBodySerializer"/> that can serialize and deserialize
        /// the remoting request message bodies created by the custom service remoting message body factory.
        /// </returns>
        IActorCommunicationRequestMessageBodySerializer CreateRequestMessageSerializer(
        ...
        /// <returns>
        /// An <see cref="IActorCommunicationResponseMessageBodySerializer"/> that can serialize and deserialize
        /// the remoting response message bodies created by the custom service remoting message body factory.
        /// </returns>
        IActorCommunicationResponseMessageBodySerializer CreateResponseMessageSerializer(
            Type serviceInterfaceType,
