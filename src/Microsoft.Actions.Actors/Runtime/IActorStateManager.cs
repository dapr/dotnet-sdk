...
namespace Microsoft.Actions.Actors.Runtime
{
    ...
    /// <summary>
    /// Represents an interface that exposes methods to manage state of an <see cref="Microsoft.Actions.Actors.Runtime.Actor" />.
    /// This interface is implemented by <see cref="Microsoft.Actions.Actors.Runtime.Actor.StateManager"/>.
    /// </summary>
