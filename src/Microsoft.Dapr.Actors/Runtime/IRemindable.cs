...
namespace Microsoft.Dapr.Actors.Runtime
{
    ...
    public interface IRemindable
    {
        ...
        /// <remarks>
        /// <para>The state of this actor is saved by the actor runtime upon completion of the task returned by this method. If an error occurs while saving the state, then all state cached by this actor's <see cref="Microsoft.Dapr.Actors.Runtime.Actor.StateManager" /> will be discarded and reloaded from previously saved state when the next actor method or reminder invocation occurs.
        /// </para>
        /// </remarks>
