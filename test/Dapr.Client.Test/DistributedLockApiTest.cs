...
namespace Dapr.Client.Test
{
    ...
    public class DistributedLockApiTest
    {
        ...
        [Fact]
        public async Task TryLockAsync_WithEmptyResourceId_ValidateRequest()
        {
            await using var client = TestClient.CreateForDaprClient();
            string storeName = "redis";
            ...
            var envelope = await request.GetRequestEnvelopeAsync<Autogenerated.TryLockRequest>();
            envelope.StoreName.Should().Be("redis");
            envelope.ResourceId.Should().BeEmpty();
            envelope.LockOwner.Should().Be("owner1");
            envelope.ExpiryInSeconds.Should().Be(1000);
        ...
        [Fact]
        public async Task TryLockAsync_WithEmptyLockOwner_ValidateRequest()
        {
            await using var client = TestClient.CreateForDaprClient();
            string storeName = "redis";
            string resourceId = "resourceId";
            ...
            envelope.StoreName.Should().Be("redis");
            envelope.ResourceId.Should().Be("resourceId");
            envelope.LockOwner.Should().BeEmpty();
            envelope.ExpiryInSeconds.Should().Be(1000);
        ...
        [Fact]
        public async Task TryLockAsync_WithEmptyExpiry_ValidateRequest()
        {
            await using var client = TestClient.CreateForDaprClient();
            string storeName = "redis";
            string resourceId = "resourceId";
            ...
            envelope.ResourceId.Should().Be("resourceId");
            envelope.LockOwner.Should().Be("owner1");
            envelope.ExpiryInSeconds.Should().Be(0);
        ...
        public async Task UnLockAsync_WithAllValues_ValidateRequest()
        {
            ...
            string lockOwner = "owner1";
            // Int32 expiryInSeconds = 1000;
            // var tryLockClient = new MockClient();
            // TryLockResponse tryLockResponse = 
            //      await tryLockClient.DaprClient.TryLock(storeName, resourceId, lockOwner, expiryInSeconds);
            ...
            var domainResponse = await request.CompleteWithMessageAsync(invokeResponse);
            domainResponse.Status.Should().Be("LockUnexist");
        }
    }
}