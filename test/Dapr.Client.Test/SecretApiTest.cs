...
namespace Dapr.Client.Test
{
    ...
    public class SecretApiTest
    {
        ...
        private async Task<TResponse> SendResponseWithSecrets<TResponse>(Dictionary<string, string> secrets, TestClient.TestGrpcRequest<TResponse> request)
        {
        ...
        private async Task<TResponse> SendBulkResponseWithSecrets<TResponse>(Dictionary<string, string> secrets, TestClient.TestGrpcRequest<TResponse> request)
        {
