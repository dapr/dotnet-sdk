...
namespace Dapr.Client.Test
{
    ...
    public class StateApiTest
    {
        ...
        public async Task ExecuteStateTransactionAsync_CanSaveState()
        {
            ...
            var state1 = new StateTransactionRequest<Widget>("stateKey1", widget1, "insert", "testEtag", metadata1, options1);

            var widget2 = new Widget() { Size = "medium", Color = "red", };
            var state2 = new StateTransactionRequest<Widget>("stateKey2", widget2, "delete");

            var widget3 = new Widget() { Size = "large", Color = "green", };
            var state3 = new StateTransactionRequest<Widget>("stateKey3", widget3, "upsert");

            var states = new List<StateTransactionRequest<Widget>>();
            states.Add(state1);
            states.Add(state2);
            states.Add(state3);

            var task = daprClient.ExecuteStateTransactionAsync<Widget>("testStore", states);
            ...
            value1.Size.Should().Be(widget1.Size);
            value1.Color.Should().Be(widget1.Color);
        ...
        var value2 = JsonSerializer.Deserialize<Widget>(valueJson2);
        value2.Size.Should().Be(widget2.Size);
        value2.Color.Should().Be(widget2.Color);
        ...
        var value3 = JsonSerializer.Deserialize<Widget>(valueJson3);
        value3.Size.Should().Be(widget3.Size);
        value3.Color.Should().Be(widget3.Color);
    }
    ...
    public async Task ExecuteStateTransactionAsync_CanClearState()
    {
        ...
        var widget1 = new Widget() { Size = "small", Color = "yellow", };
        var state1 = new StateTransactionRequest<Widget>("stateKey1", widget1, "insert");
        var state2 = new StateTransactionRequest<Widget>("stateKey2", null, "delete");
        var states = new List<StateTransactionRequest<Widget>>();
        states.Add(state1);
        states.Add(state2);
    ...
    public async Task TryExecuteStateTransactionAsync_DoesNotThrowForNonSuccess()
    {
        ...
        var states = new List<StateTransactionRequest<Widget>>();
        states.Add(state1);
        var task = daprClient.TryExecuteStateTransactionAsync<Widget>("testStore", states);
