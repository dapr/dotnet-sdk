...
namespace Dapr.Client.Test
{
    ...
    public class WorkflowApiTest
    {
        ...
        public async Task TryStartWorkflowAsync()
        {
            ...
            ByteString input = ByteString.CopyFrom(0x01);

            workflowOptions.Add("task_queue", "testQueue");

            var request = await client.CaptureGrpcRequestAsync(async daprClient =>
            {
                return await daprClient.StartWorkflow(instanceID, workflowComponent, workflowType, workflowOptions, input);
            });

            // Get Request and validate
            var envelope = await request.GetRequestEnvelopeAsync<Autogenerated.StartWorkflowRequest>();
            envelope.InstanceId.Should().Be("testInstance");
            ...
            domainResponse.InstanceId.Should().Be("testInstance");
        }
