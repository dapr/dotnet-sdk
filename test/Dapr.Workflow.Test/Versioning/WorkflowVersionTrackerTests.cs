...
public sealed class WorkflowVersionTrackerTests
{
    ...
    public void Constructor_ExtractsPatchesFromHistory()
    {
        ...
        {
            new() { WorkflowStarted = new WorkflowStartedEvent { Version = new WorkflowVersion { Patches = { "patch1" } } } },
            new() { WorkflowStarted = new WorkflowStartedEvent { Version = new WorkflowVersion { Patches = { "patch2" } } } }
        };
    ...
    public void Constructor_ExtractsPatchesFromHistory_AllowsDuplicates()
    {
        ...
        var history = new List<HistoryEvent>
        {
            new() { WorkflowStarted = new WorkflowStartedEvent { Version = new WorkflowVersion { Patches = { "p1", "p1", "p2" } } } }
        };
    ...
    public void RequestPatch_Replay_UsesHistoryMembership()
    {
        var history = new List<HistoryEvent>
        {
            new() { WorkflowStarted = new WorkflowStartedEvent { Version = new WorkflowVersion { Patches = { "p1", "p2" } } } }
        };
        var tracker = new WorkflowVersionTracker(history);
    ...
    //     var history = new List<HistoryEvent>
    //     {
    //         new() { WorkflowStarted = new() { Version = new() { Patches = { "p1", "p2" } } } }
    //     };
    //     var tracker = new WorkflowVersionTracker(history);
    //
    //     tracker.RequestPatch("p1", isReplaying: true).ShouldBeTrue();
    ...
    [Fact]
    public void OnWorkflowStarted_WithNullVersion_DoesNothing()
    {
        var tracker = new WorkflowVersionTracker([]);
    ...
    public void RequestPatch_WhenAlreadyDeterminedFalse_ReturnsFalse()
    {
        var history = new List<HistoryEvent>
        {
            new() { WorkflowStarted = new WorkflowStartedEvent { Version = new WorkflowVersion { Patches = { "p1" } } } }
        };
        var tracker = new WorkflowVersionTracker(history);
